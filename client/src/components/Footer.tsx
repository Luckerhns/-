    ...
    <footer className={styles.footer}>
      <div className={styles.footerContent}>
        <div className={styles.footer__notice}>
          Сайт является познавательным для учебных публикации и учебных материалов и копированию не подлежит 
        </div>
        <div className={styles.copyright}>
          &copy; {new Date().getFullYear()} ИП Мамедов Максим Тельманович. Все права
          защищены.
        </div>
